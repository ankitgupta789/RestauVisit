...
function VerifyEmail() {
  ...
  useEffect(() => {       
    //console.log(signupData)  ;       // Only allow access of this route when user has filled the signup form
      ...
      { loading ? ( <div className="spinner"></div> ) : (
            ...
            <div className="max-w-[500px] p-4 lg:p-8">
              ...
              <form onSubmit={handleVerifyAndSignup}>
                ...
                <OtpInput value={otp}
                 onChange={setOtp} numInputs={6}                      // this otp box conatiner is copied from internet  
                  renderInput = {(props) => (
